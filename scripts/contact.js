...
//the contents of the contact-page are replaced with a single <p> 
...
var cpage = document.getElementById("contact-page");
function tymessage(){
    cpage.innerHTML = "<p style='font-size: 24px';>Thank you for your message!</p>";
}
sbutton.addEventListener('click',tymessage);